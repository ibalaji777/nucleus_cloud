...
import addSheduleDowntime from "../vue/addSheduleDowntime.vue";
import mainDowntime from "../vue/mainDowntime.vue";

import addGroupDialog from "../vue/addGroupDialog.vue";
import VueSimpleAlert from "vue-simple-alert";
Vue.use(VueSimpleAlert);

Vue.component("mainDowntime", mainDowntime);
Vue.component("addEmployee", addEmployee);
Vue.component("addSheduleDowntime", addSheduleDowntime);
