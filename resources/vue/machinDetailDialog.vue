      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <div class="flex">
            <h4>MACHINE CODE</h4>
            :
            <h4>{{ $store.state.eventMachineDetail.code }}</h4>
          </div>

          <div class="flex">
            <h4>USERNAME</h4>
            :
            <h4>{{ $store.state.eventMachineDetail.username }}</h4>
          </div>
          <div class="flex">
            <h4>PASSWORD</h4>
            :
            <h4>{{ $store.state.eventMachineDetail.password }}</h4>
          </div>
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
